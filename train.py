...
class Trainer(object):
    def __init__(self, args):
        ...
        self.train_loader, self.val_loader, self.nclass = make_data_loader(self.baseroot, args, **kwargs)
        ...
        if args.use_balanced_weights:
            classes_weights_path = os.path.join(self.baseroot, args.dataset+'_classes_weights.npy')
